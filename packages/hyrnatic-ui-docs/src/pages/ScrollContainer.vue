<template>
    <page title="Scroll Container">
        ...
        <h-scroll-container :auto-hide="true" container-classes="test-c" wrapper-classes="test-w" :style="{width: '200px', height: largerContainer ? '600px' : '400px'}">
...
export default defineComponent({
    ...
    setup(props, ctx: SetupContext) {
        ...
        const largerContainer = ref(false);
